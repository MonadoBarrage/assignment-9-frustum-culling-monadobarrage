...
#include <vector>
#include <memory>
#include "GLViewCS4350_Assignment7.h" //GLView subclass instantiated to drive this simulation
...
int main( int argc, char* argv[] )
{
   ...
   do
   {
      std::unique_ptr< Aftr::GLViewCS4350_Assignment7 > glView( Aftr::GLViewCS4350_Assignment7::New( args ) );
